...
const Features = () => {
  return (
    <div className={ `${styles.gpt3__features} ${styles.section__padding} `} id="possibility">
        <div className={styles.gpt3__features__heading}>
        ...
        <div className={styles.gpt3__features__container}>
